        ...
        >
          <div style={{ margin: "1em",  color: "black" }} id="tickettype">
            ...
            >
              ...
              >
                <p > Ticket type</p>
                <h2 style={{ marginTop: "-0.5em" }}> 15-19  tickets</h2>
                <p > save 15% on your tickets to collision 2023. price oer ticket</p>
                <br />{" "}
              ...
              <div style={{ marginLeft: "-1em", marginTop: "-1em" }} id="price">
                <div id="price" style={{ marginLeft: "1em", marginRight: "1em" }}>
                  <div style={{ marginTop: "-2em", display: "inline-flex" }}>
                    <div>ca$</div>
                    <h1 style={{ marginTop: "-0.25em" }}>845</h1>
                  </div>
                  <div>CA$955 incl. taxes</div>
                </div>
