        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              Who is attending from your country? Below, you’ll find a list of the top speakers and attendees who will join us from around the world at Collision 2023.
