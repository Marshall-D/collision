            ...
            >
              <div style={{ color: "white" }}>
                <div style={{ marginBottom: "2em" }}>
                  <span style={{ color: "white" }}>"We had many high quality conversations that will generate collaborations… </span>
                </div>
                Wolfram Research              </div>
            </div>
            <div
              style={{ padding: "2em", width: "50%", backgroundColor: "black" }}
            >
...
Forbes              </div>
          ...
          <div style={{ display: "inline-flex" }}>
            ...
            >
              <div style={{ color: "white" }}>
                <div style={{ marginBottom: "2em" }}>
                  <span style={{ color: "white" }}>"At Collision, you’ll have the opportunity to put your company centre stage in… ”</span>
                </div>
                DigitalOcean
              </div>
            </div>
            <div>
              <img
                ...
                src="
                https://web-summit-library.imgix.net/collision/2019/06/Magic-Leap-Booth-during-day-three-of-Collision-2019-at-Enercare-Center-in-Toronto.jpg?auto=compress%2Cformat&ixlib=php-3.3.0&s=ee02cf9347f46c25fb99e074fd231163"                alt="carmelo-anthony_nba-all-star-entrepreneur_centre-stage-2022"
                loading="eager"
              />
            </div>
          </div>
  ...
  export default Section4Partner;
